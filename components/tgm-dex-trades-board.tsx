      ...
      <div className="border-b border-[#20222f] p-4">
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-normal text-sm">DEX Trades</span>
        ...
        <div className={`${filterOpen ? 'grid' : 'hidden'} lg:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3`}>
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center rounded-md border border-[#20222f] bg-[#171a26] p-0.5">
              <Button
                variant="ghost"
                size="sm"
                className={`h-7 text-[10px] px-2 rounded-sm flex-1 ${actionFilter === "ALL" ? "bg-blue-500/20 text-blue-300 shadow-sm" : "text-gray-400 hover:text-gray-200"}`}
              ...
              <Button
                variant="ghost"
                size="sm"
                className={`h-7 text-[10px] px-2 rounded-sm flex-1 ${actionFilter === "BUY" ? "bg-green-500/20 text-green-300 shadow-sm" : "text-gray-400 hover:text-gray-200"}`}
              ...
              <Button
                variant="ghost"
                size="sm"
                className={`h-7 text-[10px] px-2 rounded-sm flex-1 ${actionFilter === "SELL" ? "bg-red-500/20 text-red-300 shadow-sm" : "text-gray-400 hover:text-gray-200"}`}
          ...
          <div className="lg:col-span-2">
            <Button
              ...
              size="sm"
              className={`w-full h-8 text-xs ${onlySmartMoney ? "bg-blue-500/20 border-blue-500/50 text-blue-300" : "border-[#20222f] bg-[#171a26] text-gray-400 hover:bg-[#20222f]"}`}
          ...
          {/* Smart Money Labels */}
          <div className="lg:col-span-9 flex items-center gap-1 flex-wrap">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-stretch text-[10px] uppercase tracking-wide text-gray-500 whitespace-nowrap">
                    <div className="sticky left-0 z-10 bg-[#141723] flex items-center gap-3 min-w-[200px] py-2 pl-7 pr-3 rounded-l border-y border-l border-transparent">
                      ...
                      <div className="min-w-[140px]">Trader</div>
                    </div>
                    <div className="flex-1 flex items-center justify-end min-w-0 gap-0 py-2 pr-3 border-y border-r border-transparent">
                      ...
                      <div className="w-[100px] text-center">Token</div>
                      <div className="w-[100px] text-center">Traded</div>
                      <div className="w-[80px] text-center">Amount</div>
                      <div className="w-[80px] text-center">Traded Amt</div>
                      ...
                      >
                        ...
                        <div className="sticky left-0 z-10 flex items-stretch pl-4 bg-[#141723]">
                          <div className="bg-[#171a26] group-hover:bg-[#1c1e2b] border-l border-y border-[#20222f] group-hover:border-[#272936] flex items-center gap-2 min-w-[200px] ml-0 pl-3 py-2.5 rounded-l transition-colors duration-150">
                            ...
                            <div className="flex flex-col min-w-[140px]">
                              ...
                              <span className="text-[10px] text-gray-500">{trade.trader_address_label || "Unknown"}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex-1 flex items-center justify-end min-w-0 gap-0 pr-3 py-2.5 bg-[#171a26] border-y border-r border-[#20222f] rounded-r group-hover:bg-[#1c1e2b] group-hover:border-[#272936] transition-colors duration-150">
                          ...
                          <div className="w-[70px] flex justify-center">
                            <Badge
                              variant="secondary"
                              className={`text-[10px] h-5 border-0 px-2 rounded-full ${isBuy ? "bg-green-500/20 text-green-300" : "bg-red-500/20 text-red-300"
                                }`}
                            >
                              {trade.action}
                            </Badge>
                          ...
                          <div className="w-[100px] flex justify-center">
                            <span className="text-xs text-gray-300">{trade.token_name}</span>
                          </div>

                          {/* Traded Token */}
                          <div className="w-[100px] flex justify-center">
                            <span className="text-xs text-gray-300">{trade.traded_token_name}</span>
                          </div>
                          ...
                          <div className="w-[80px] flex justify-center">
                            <span className="text-xs text-gray-300 font-mono tabular-nums">
                              {formatNumber(trade.traded_token_amount)}
                            </span>
                          </div>
                          ...
                          <div className="w-[90px] flex justify-center">
                            <span className="text-xs text-white font-semibold font-mono tabular-nums">
                              {formatUSD(trade.estimated_value_usd)}
                            </span>
                          </div>
                        </div>
                      </div>
