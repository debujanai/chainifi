            ...
            <div key={section.section} className="mb-6">
              ...
              <div className="space-y-1">
                <div className="relative flex items-center gap-3 pr-3 pl-0 py-2 text-[10px] uppercase tracking-wide text-gray-500">
                  ...
                  <div className="w-[240px] flex-shrink-0">From</div>
                  <div className="w-[40px] flex-shrink-0"></div>
                  <div className="w-[240px] flex-shrink-0">To</div>
                        ...
                        <div className="min-w-[100px]">
                          <Badge
                            ...
                            className={`text-[10px] h-5 border-0 px-2 rounded-full ${
                              isCex ? "bg-yellow-500/20 text-yellow-300" : isDex ? "bg-blue-500/20 text-blue-300" : "bg-gray-500/20 text-gray-300"
                            }`}
                          >
